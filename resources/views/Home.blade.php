...
<body class="flex flex-col min-h-screen bg-gray-100">
    ...
    <div class="flex flex-col items-center justify-center flex-grow -mt-60">
        ...
        <a href="#" class="bg-green-500 text-white px-6 py-3 rounded-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500">Go to Product Page</a>
    </div>
</body>
</html>
